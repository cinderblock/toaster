declare module 'nrf-intel-hex' {
  class MemoryMap extends Map<number, Uint8Array> {
    /**
     ...
     * only numeric keys.
     */
    constructor(blocks?: Iterable<[number, Uint8Array]> | { [addr: number]: Uint8Array } | undefined | null);
     ...
     */
    static overlapMemoryMaps<T = unknown>(memoryMaps: Map<T, MemoryMap>): Map<T, Uint8Array>;
     ...
     */
    getUint32(offset: number, littleEndian?: boolean | undefined): number | undefined;
     ...
     * @return {MemoryMap}
     */
    static fromPaddedUint8Array(bytes: Uint8Array, padByte?: number, minPadLength?: number): MemoryMap;
